...
<script>
  export default {
    ...
    mounted() {
      ...
      // let AlignStyle = this.editor.import('attributors/style/align');
      ...
      setTimeout(() => {
        this.content = `<h1 class="ql-align-center">
                        ...
                        <p><br></p>
                        <p><strong class="ql-font-serif"><em><s><u>W Can a man still be brave if he's afraid? That is the only time a man can be brave. </u></s></em></strong></p>
                        <p><br></p>
                        ...
                        <p><br></p>
                        <blockquote><em class="ql-font-serif">Fear cuts deeper than swords.</em></blockquote>
                        <p><br></p>
                        ...
                        <ol>
                          ...
                          <li>Every flight begins with a fall.</li>
                        </ol>
                        <p><br></p>
                        <ul>
                          <li>Every flight begins with a fall.</li>
